...
import { c as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash, S as SITE, M as METADATA, a as getPermalink } from '../chunks/permalinks_TesD2X4Z.mjs';
import { Traverse } from 'neotraverse/modern';
import pLimit from 'p-limit';
import { z, ZodIssueCode } from 'zod';
import { removeBase, isRemotePath, prependForwardSlash } from '@astrojs/internal-helpers/path';
import { V as VALID_INPUT_FORMATS } from '../chunks/consts_CJVA2lEV.mjs';
import { A as AstroError, R as RenderUndefinedEntryError, c as createComponent, r as renderTemplate, u as unescapeHTML, U as UnknownContentCollectionError, d as renderUniqueStylesheet, e as renderScriptElement, f as createHeadAndContent, a as renderComponent } from '../chunks/astro/server_Z5exMJzc.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('../chunks/_astro_data-layer-content_CPVgk76g.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://reclutamiento-ejercito.netlify.app/", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('../chunks/_astro_assets_CNjfFFFx.mjs').then(n => n._);
...
const GET = async () => {
  ...
  const rss = await getRssString({
    ...
    site: "https://reclutamiento-ejercito.netlify.app/",
