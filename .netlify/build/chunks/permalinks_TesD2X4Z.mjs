...
const SITE = {"name":"Servicio de Reclutamiento Militar","site":"https://reclutamiento-ejercito.netlify.app/","base":"/","trailingSlash":false,"googleSiteVerificationId":"orcPxI47GSa-cRvY11tUe6iGg2IO_RPvnA1q95iEM3M"};
                    const I18N = {"language":"en","textDirection":"ltr"};
                    const METADATA = {"title":{"default":"Servicio de Reclutamiento Militar","template":"%s — Servicio de Reclutamiento Militar"},"description":"🚀 Suitable for Startups, Small Business, Sass Websites, Professional Portfolios, Marketing Websites, Landing Pages & Blogs.","robots":{"index":true,"follow":true},"openGraph":{"type":"website","site_name":"Servicio de Reclutamiento Militar","images":[{"url":"~/assets/images/army.webp","width":1200,"height":628}]},"twitter":{"handle":"@onwidget","site":"@onwidget","cardType":"summary_large_image"}};
